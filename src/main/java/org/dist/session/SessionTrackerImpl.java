...
public class SessionTrackerImpl extends Thread implements SessionTracker {
    ...
    private final org.apache.zookeeper.server.ExpiryQueue<SessionImpl> sessionExpiryQueue;
    ...
    private static class DefaultSessionExpirer implements SessionExpirer {
        private long serverId;

        public DefaultSessionExpirer(long serverId) {
    ...
    public SessionTrackerImpl(int tickTime, long serverId) {
        this.expirer = new DefaultSessionExpirer(serverId);
        this.sessionExpiryQueue = new ExpiryQueue<SessionImpl>(tickTime);
        this.sessionsWithTimeout = new ConcurrentHashMap<Long, Integer>();
